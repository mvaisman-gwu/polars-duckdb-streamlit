...
def estimate_file_size(weather_station_names, num_rows_to_create):
    ...
    return f"The estimated generated file size is:  {human_file_size}. (The actual size may be smaller.)"
...
def build_test_data(weather_station_names, num_rows_to_create):
    ...
    print('Creating sample data. This can take up to 10 minutes...')
